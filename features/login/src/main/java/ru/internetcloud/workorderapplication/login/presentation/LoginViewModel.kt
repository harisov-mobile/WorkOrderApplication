...
import ru.internetcloud.workorderapplication.common.domain.usecase.synchrooperation.LoadMockDataUseCase
import ru.internetcloud.workorderapplication.login.domain.usecase.CheckAuthParametersUseCase
import ru.internetcloud.workorderapplication.login.domain.usecase.SetAuthParametersUseCase
...
class LoginViewModel @Inject constructor(
    ...
    private fun loadDemoData() {
        viewModelScope.launch {
            ...
            savedStateHandle[KEY_LOGIN_STATE] = state.value.copy(canContinueDemoMode = true) // демо-режим
        }
    }
