...
import ru.internetcloud.workorderapplication.common.presentation.util.convertToString
import ru.internetcloud.workorderapplication.common.presentation.util.launchAndCollectIn
import ru.internetcloud.workorderapplication.common.presentation.util.toIntOrDefault
...
import ru.internetcloud.workorderapplication.workorderdetail.databinding.FragmentWorkOrderBinding
import ru.internetcloud.workorderapplication.workorderdetail.presentation.car.CarPickerFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.department.DepartmentPickerFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.employee.EmployeePickerFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.jobdetails.JobDetailFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.jobdetails.JobDetailListAdapter
import ru.internetcloud.workorderapplication.workorderdetail.presentation.jobdetails.JobDetailListListener
...
import ru.internetcloud.workorderapplication.workorderdetail.presentation.partner.PartnerPickerFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.performers.PerformerDetailFragment
import ru.internetcloud.workorderapplication.workorderdetail.presentation.performers.PerformerDetailListAdapter
...
class WorkOrderFragment : Fragment(R.layout.fragment_work_order), FragmentResultListener {
    ...
    @Inject
    lateinit var navigationApi: NavigationApi<WorkOrderDetailDirections>

    private val binding by viewBinding(FragmentWorkOrderBinding::bind)

    //private val args by navArgs<WorkOrderFragmentArgs>()
    private val args by getArgs<WorkOrderDetailArgs>()
